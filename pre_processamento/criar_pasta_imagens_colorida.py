from  pre_processamento_colorido import pre_processamento_colorido
import cv2
import os
import numpy as np

# Pasta contendo suas imagens de treinamento originais
input_folder = 'C:\\Users\\carlo\\Documents\\Processamento-de-imagem\\imagens\\train'

# Pasta para salvar as imagens redimensionadas
output_folder = 'C:\\Users\\carlo\\Documents\\Processamento-de-imagem\\imagens_pre_processadas_coloridas\\train'
...
for image_file in image_files:
    ...
    img = pre_processamento_colorido(image)
